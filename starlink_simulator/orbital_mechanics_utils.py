    ...
    for x in range(const.NUM_ORB):
        ...
        for y in range(const.NUM_OBJ):
            ...
            imo = MovingObject(object_id, y, orbit_id, object_data[object_id][0].latitude.degrees,
                               object_data[object_id][0].longitude.degrees, const.SAT_ALT, object_data[object_id][1][0], object_data[object_id][1][1], object_data[object_id][1][2], laser_left_id, laser_left_id_in_orbit, laser_right_id, laser_right_id_in_orbit)
